...
(function ($) {  
    var defaultSettings = {  
        url: baseUrl+"upload/uploadPic",                                 //上传地址  
        buttonFeature: true,                    //true:点击按钮时仅选择文件； false:选择完文件后立即上传  
        fileSuffixs: ["bmp", "jpg", "jpeg", "gif", "png"],             //允许上传的文件后缀名列表  
            ...
            if (that.settings.perviewElementId) {  
                if (!that.settings.perviewImgStyle) {  
                    ...
                    $(main).find("img[name]").hover(function () {  
                        ...
                        $(this).parents("li").fadeOut(10, function () {  
                            $(this).remove();  
                        });  
                    });  
...
var perviewImage = {  
    timers: [],  
    closeImg: {  
        before: "images/cancel_03.png",  
        after: "images/cancel_03.png"  
    },  
    loading: "",  
    fileImg: "",  
    //获取预览元素  
    ...
    createPreviewElement: function (/*关闭图片名称*/name,/*上传时的文件名*/file, /*预览时的样式*/style) {  
      ...
      //text.innerHTML = file;  
        ...
        var right = 0 - window.parseInt(style.width) +190;  
        ...
        imgloading.style.right = loadright + "10px";  
